			...
			return {
				...
				option2: {
					...
					series: [{
							...
							color:'orange',
							stack: '总量',
							data: [0, 0, 200, 134, 90, 230, 210, 20, 70]
						},
						{
							name: '贷款转化率(%)',
							type: 'line',
							color:'#a200ff',
							stack: '总量2',
							data: [220, 182, 191, 234, 290, 330, 310, 20, 10]
						},
						{
							name: '贷款人数',
							type: 'line',
							color:'#00eaff',
							stack: '总量3',
							data: [150, 232, 201, 154, 190, 330, 410, 320, 20]
						},
						{
							name: '直接访问',
							type: 'line',
							color:'#ff008a',
							stack: '总量4',
							data: [1134, 200, 301, 334, 700, 330, 320, 700, 900]
						},
						{
							name: '搜索引擎',
							color:'#01d94d',
